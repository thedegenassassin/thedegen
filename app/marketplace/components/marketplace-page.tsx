      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-lg">
            Discover, collect, and trade extraordinary NFTs across all blockchains
          </p>
        </div>
        ...
        <div className="mb-8 space-y-4">
          <div className="relative">
            ...
            <Input
              ...
              aria-label="Search NFTs, collections, or creators"
            />
          </div>
        ...
        <div className="flex gap-8">
          {/* Filters Sidebar */}
          {showFilters && (
            <aside className="w-80 space-y-6" aria-label="NFT Filters">
